...
**[#4556](https://github.com/ballerina-platform/ballerina-library/issues/4556)** [Bug]: Cannot invoke resource methods which contains path parameter with only the parameter type in services
